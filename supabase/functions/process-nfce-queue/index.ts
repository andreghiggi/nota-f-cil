...
async function sendSoapToSefaz(
  ...
  // ICP-Brasil Root CA certificates required for SEFAZ TLS verification
  // These are the official root CAs from gov.br/iti repository
  const ICP_BRASIL_CAS = [
    // AC Raiz ICP-Brasil v5 (RSA) - most common for fiscal certificates
    `-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`,
    // AC Raiz ICP-Brasil v10 (SSL) - for SSL/TLS certificates
    `-----BEGIN CERTIFICATE-----
